...
def compute_object_est_error(gt_list, est_list):
    ...
    If there are more estimations than the number of targets (e.g. only 1 target pear, but detected 2),
        then take the average error of the 2 detections

    if there are fewer estimations than the number of targets (e.g. 2 target pears, but only detected 1),
